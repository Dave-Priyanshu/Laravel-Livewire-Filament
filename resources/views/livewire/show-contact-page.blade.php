								...
								<form wire:submit="submit">
									<!-- Full Name -->
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model="name" type="text" class="form-control shadow-none @error('name') is-invalid @enderror" name="name">
                                            @error('name')
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model="email" type="email" class="form-control shadow-none @error('email') is-invalid @enderror" name="email" id="email">
                                            @error('email')
                                                <p class="invalid-feedback d-block">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <textarea wire:model="message" class="form-control shadow-none @error('message') is-invalid @enderror" name="message" id="message" rows="3"></textarea>
                                            @error('message')
                                                <p class="invalid-feedback d-block">{{ $message }}</p>
                                            @enderror
                                        </div>
