		...
		<div class="row">
			<div class="col-8 mx-auto text-center">
				...
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					...
					<li class="list-inline-item">/ &nbsp; <a wire:navigate href="#">Our Team</a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="col-xl-3 col-lg-4 col-md-6 mt-4">
				<div class="card bg-transparent border-0 text-center">
					<div class="card-img">
                        ...
                        @if ($member->email != '' || $member->insta_url != '' || $member->linkd_url )
                            
                        
						<ul class="card-social list-inline">
                            @if ($member->email != '')
                                <li class="list-inline-item"><a class="email" target="_blank" href="{{ $member->email }}"><i class="fas fa-envelope"></i></a>
                                </li>    
                            @endif
                            ...
                            @if ($member->linkd_url)
                                <li class="list-inline-item"><a class="linkedin" target="_blank" href="{{ $member->linkd_url }}"><i class="fab fa-linkedin"></i></a>
                                </li>
                            @endif
						</ul>
                        @endif
